...
const AuthenticatedHomepage: React.FC<AuthenticatedHomepageProps> = ({
  ...
  const safeIndex = Math.max(
    0,
    Math.min(currentChallengeIndex, validChallenges.length - 1)
  );
            ...
            <div className="text-center mb-6 mt-0 md:mb-8">
              ...
              <h1 className="text-2xl md:text-2xl lg:text-3xl font-bold text-greenDark mb-0 md:mb-2 px-4">
                {userName ? (
                  ...
                  <>
                    <span className="block md:hidden">Hai!</span>
                    <span className="hidden md:block">
                      Selamat Datang Kembali!
                    </span>
                  </>
                )}
                <span className="text-tealLight block text-base md:text-2lg lg:text-xl mt-2">
                  <span className="block md:hidden">
                    Yuk lanjutkan aksi hijaumu hari ini
                  </span>
                  <span className="hidden md:block">
                    Yuk lanjutkan aksi hijau bersama hari ini
                  </span>
                </span>
              </h1>
            </div>
                  ...
                  {dailyChallenges.length > 0 && currentChallenge ? (
                      ...
                      <div className="relative z-10">
                        ...
                        <div className="flex items-center justify-center gap-1 md:gap-2 px-1 md:px-2">
                          ...
                          <div
                            ...
                            onClick={() =>
                              (window.location.href = `/aksi?challenge=${currentChallenge.id}&mode=challenge`)
                            }
                          >
                                  ...
                                  <div className="mb-3 p-3 bg-white/10 rounded-lg border border-white/20">
                                    ...
                                    {Array.isArray(
                                      ...
                                      <ul className="space-y-1">
                                        {currentChallenge.instructions.map(
                                          (instruction, index) => (
                                            <li
                                              key={index}
                                              className="text-white/90 text-xs leading-relaxed flex items-start"
                                            >
                                ...
                                <div className="flex items-center gap-2 flex-wrap">
                                  <div className="bg-[#FFEC86]/40 border border-[#FFEC86]/60 px-2 py-1 rounded-full flex items-center gap-1">
                                    <span className="text-xs font-medium text-red">
                                      x{currentChallenge.double_points} poin
                                    </span>
                                  </div>
                                  <div
                    ...
                    <div className="flex items-center justify-center py-8">
                      <div className="text-center">
                        ...
                        <p className="text-white/80 text-sm">
                          Sedang mempersiapkan tantangan menarik untuk Anda
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-4">
                    {activityLoading ? (
                      ...
                      activityHistory.map((activity) => (
                        <div
                          key={activity.id}
                          className="flex items-center justify-between p-4 bg-whiteGreen rounded-xl md:text-3xl transition-colors duration-200 border border-gray-100"
                        >
                          <div className="flex items-center gap-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <h3 className="font-semibold text-greenDark text-base">
                                  {activity.type}
                                </h3>
                          ...
                          <div className="text-right">
                            <span className="text-yellowGold font-bold text-lg">
                              +{activity.points}
                            </span>
                            <p className="font-bold text-yellowGold text-base md:text-sm">
                              Poin
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="text-center py-12 text-gray-500">
                        ...
                        <p className="text-sm mb-4">
                          Mulai buat aksi lingkungan pertama Anda!
                        </p>
                        <button
                  ...
                  <div className="bg-whiteMint rounded-2xl shadow-lg p-6 h-full flex flex-col justify-center">
                    <div className="text-center mb-6">
                      ...
                      <p className="text-gray-600 mb-4 text-sm lg:text-base">
                        ...
                        Indonesia. Dapatkan insight mendalam tentang kontribusi
                        setiap provinsi dan pencapaian komunitas.
                      </p>
                    </div>
                    ...
                    <div className="text-center">
                      <p className="text-sm text-gray-500 mb-4">
                        Laporan ini berisi data real-time dari aktivitas
                        pengguna dan dampak lingkungan yang terukur
                      </p>
